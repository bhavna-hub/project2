...
This report seeks to find out whether implementing which policy among lockdown, masks and testing before April 1 have significant effect on a countries case proportion growth rate between April and August.  Masks prevent air from flowing from one person to another. This prevents highly infectious diseases like COVID19 from spreading. So it can be hypothesized that the countries requiring masks would have a lower case proportion. 
