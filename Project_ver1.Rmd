...
df1 = data.frame(masking_policy_april$country, august_results$case.growth, masking_policy_april$masks,
                 masking_policy_april$domestic,
                 masking_policy_april$testing )
```
