...
model_growth.rate.logistic<-lm(data=dat.growthrates,formula=unlist(gr)~days_testing+days_mask+days_restaurant_close+days_lockdown)
model_growth.rate.logistic<-lm(data=dat.growthrates,formula=unlist(gr)~days_mask)
