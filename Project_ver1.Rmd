...
```{r}
plot(model_growth.rate.logistic, which = 1)
```
...
```{r}
plot(model_growth.rate.logistic, which = 2)
```
...
```{r}
plot(model_growth.rate.logistic, which = 3)
```
...
```{r}
plot(model_growth.rate.logistic, which = 4)
```
