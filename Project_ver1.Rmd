...
boxplot(df.augresult$case.growth, df.augresult.nm$case.growth,
        ...
        ylim=c(0, 1000),
        main='Boxplot of case proportion growth rate from Apr to Aug based on Apr 1st mask policy')
```
...
boxplot(df.augresult.test$case.growth, df.augresult.notest$case.growth,
        ...
        ylim=c(0, 1000),
        main='Boxplot of case proportion growth rate from Apr to Aug based on Apr 1st testing policy')
```
...
boxplot(df.augresult.ld$case.growth, df.augresult.nold$case.growth,
        ...
        ylim=c(0,1000),
        main='Boxplot of case proportion growth rate from Apr to Aug based on Apr 1st lockdown policy')
...
august_case_prop = subset(df$case_proportion, date ='2020-08-31' )
august_case_mort = subset(df$Case_mort, date=  '2020-08-31')
ggplot()+
